...
import { Globe, Mail, MapPin, MessageCircleMore, Phone, Clipboard } from "lucide-react";
    ...
    <div className="space-y-4 w-full lg:w-[30%]">
      ...
      <div className="bg-white rounded-lg px-6">
        ...
        <div className="py-6 relative border-t">
          ...
          />
          <p className="mt-4 text-center text-sm text-gray-600">{timeLeft}</p>
        </div>
      </div>
        ...
        <div className="py-6 relative border-t">
          ...
          <div className="flex gap-2 items-center mt-4">
            ...
            <div className="flex space-x-2">
              ...
              <Button onClick={copyLink} className="bg-gray-600 hover:bg-gray-500">
                <Clipboard /> Copy Link
              </Button>
