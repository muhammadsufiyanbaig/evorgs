...
const mockVoucher = {
  ...
  applicableFor: "Specific Services" as "All Services" | "Specific Services",
...
export default function EditVoucherPage() {
  ...
  const [formData, setFormData] = useState(mockVoucher)
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Redirect back to voucher details
    router.push(`/vendor/vouchers/${params.id}`)
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-white">
      <div className="container mx-auto p-6 max-w-4xl">
        ...
        <div className="flex items-center gap-4 mb-6">
          <Link href={`/vendor/vouchers/${params.id}`}>
            <Button
              variant="outline"
              size="icon"
          ...
          <div>
            <h1 className="text-3xl font-bold text-orange-900">Edit Voucher</h1>
            <p className="text-orange-700">Update your voucher details and settings</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card className="border-orange-200 shadow-lg bg-white">
            <CardHeader className="bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-t-lg">
              ...
              <CardDescription className="text-orange-100">Update the basic details for your voucher</CardDescription>
            </CardHeader>
          ...
          <Card className="border-orange-200 shadow-lg bg-white">
            <CardHeader className="bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-t-lg">
              ...
              <CardDescription className="text-orange-100">Update the status of this voucher</CardDescription>
            </CardHeader>
