...
import { CloseIcon, MenuIcon } from "@/utils/Icons/LandingPage";
...
export default function Header() {
  ...
  return (
    <header className="z-[999] relative">
      <motion.div
        className="fixed top-0 left-1/2 h-[4.5rem] w-full rounded-none border-2 border-white border-opacity-40 bg-transparent bg-opacity-80 shadow-xl shadow-black/[0.03] backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.25rem] sm:w-[36rem] sm:rounded-full dark:bg-gray-950 dark:border-black/40 dark:bg-opacity-75"
            ...
            >
              ...
              >
                ...
                {link.name === activeSection && (
                  <motion.span
                    className="bg-orange-500 p-3 rounded-full absolute inset-0 -z-10 dark:bg-orange-500"
          ...
          {links.map((link) => (
            ...
            >
              ...
              >
                ...
                {link.name === activeSection && (
                  <motion.span
                    className="bg-orange-500 rounded-full absolute inset-0 -z-10 dark:bg-orange-500"
                    layoutId="activeSection"
                    transition={{
                      type: "spring",
                      stiffness: 380,
