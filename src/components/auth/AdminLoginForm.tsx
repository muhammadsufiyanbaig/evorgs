        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-gray-500 transition-colors"
          ...
          <div className="mt-6 space-y-4">
            <div className="text-center text-sm space-y-2">
              <p className="text-gray-600">Other portals:</p>
              <div className="flex gap-2 justify-center">
                <Link href="/auth/login" className="text-gray-500 hover:text-gray-600 font-semibold">
                  User
                </Link>
                <span className="text-gray-400">•</span>
                <Link href="/vendor/auth/login" className="text-gray-500 hover:text-gray-600 font-semibold">
                  Vendor
                </Link>
              </div>
            </div>
