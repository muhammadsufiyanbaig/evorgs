import { ContactIconProps, FooterIconProps, HeaderIconProps } from "../interfaces";
...
export const CloseIcon = ({ className }: HeaderIconProps) => (
  ...
  export const Facebook = ({ color, height = "25px", width = "25px" }: FooterIconProps) => {
    return (
      <svg
        fill={color}
        version="1.1"
  ...
  export const Instagram = ({ color, height = "24px", width = "24px" }: FooterIconProps) => {
    return (
      <svg
        viewBox="0 0 24 24"
        fill="none"
  ...
  export const Twitter = ({ color, height = "24px", width = "24px" }: FooterIconProps) => {
    return (
 ...
 export  const Quotes = ({ height = '64px', width = '64px', color }: FooterIconProps) => {
    return (
      <svg
        fill={color}
        width={width}
